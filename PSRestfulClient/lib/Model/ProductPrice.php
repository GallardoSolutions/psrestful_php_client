...
class ProductPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets quantity_max
     *
     * @param int $quantity_max quantity_max
     *
     * @return self
     */
     ...
     * Sets quantity_min
     *
     * @param int $quantity_min quantity_min
     *
     * @return self
     */
    public function setQuantityMin($quantity_min)
    {
        if (is_null($quantity_min)) {
            throw new \InvalidArgumentException('non-nullable quantity_min cannot be null');
        }
    ...
    public function setPrice($price)
    {
        ...
        if ((!preg_match("/^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$/", ObjectSerializer::toString($price)))) {
            throw new \InvalidArgumentException("invalid value for \$price when calling ProductPrice., must conform to the pattern /^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$/.");
        }
