...
/**
 * AvailableCharge Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AvailableCharge implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AvailableCharge';
    ...
    */
    ...
    public function setChargeDescription($charge_description)
    {
        if (is_null($charge_description)) {
            array_push($this->openAPINullablesSetToNull, 'charge_description');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('charge_description', $nullablesSetToNull);
            if ($index !== FALSE) {
