...
/**
 * ThirdPartyAccount Class Doc Comment
 *
 * @category Class
 * @description The third party account information for the shipping account to use and the business entity that is paying for the shipping
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ThirdPartyAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ThirdPartyAccount';
