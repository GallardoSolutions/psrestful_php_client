...
/**
 * SalesOrderNumber Class Doc Comment
 *
 * @category Class
 * @description Field       Description     Data Type       Required salesOrderNumber    The sales order number  64 STRING       TRUE
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SalesOrderNumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalesOrderNumber';
